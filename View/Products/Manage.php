...
<div style="width: 966px; float: right; margin-right: 116px;padding-bottom: 70px;margin-top: -34px;">
    ...
    <h5>
        ...
        <span class="icon" style="font-size: large;">

            <!-- <a href="admin.php?mod=products&act=insert" style="text-decoration: none;
    color: black;
    font-weight: bold;">
    ...
    <p class="btn-more box noprint"><strong><a href="admin.php?mod=products&act=insert"><i class="fas fa-plus-circle"></i> </a>
        Thêm Sản Phẩm
    </a></strong></p>
</div> </article>